    ...
    return(
        ...
        <div className="flex flex-col items-center text-center justify-center">
            ...
            <div className="relative mt-15">
                ...
                <input type="text" className="h-15 w-170 text-3xl pl-5 bg-linear-to-br from-zinc-800 to-white"></input>
            </div>
            <div className="relative mt-18">
                ...
                <input type="password" className="h-15 w-170 text-3xl pl-5 bg-linear-to-br from-zinc-800 to-white"></input>
            ...
            <button className="font-['Quicksand'] text-2xl bg-linear-to-br from-black/10 to-white w-60 h-15 rounded-4xl opacity-75 mt-25 hover:opacity-100 hover:cursor-pointer ">Submit</button>
        </div>
        </>
    )
}
